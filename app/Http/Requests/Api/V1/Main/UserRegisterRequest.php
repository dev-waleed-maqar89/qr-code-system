...
class UserRegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['required', new SpecificStartAndLength(9, [5]), 'unique:users'],
            'identity' => ['required', new SpecificStartAndLength(10, [1, 2]), 'unique:users'],
    ...
    public function messages(): array
    {
        return [
            ...
            'phone.unique' => __('validation/userregister.phone.unique'),
            'identity.required' => __('validation/userregister.identity.required'),
            'identity.unique' => __('validation/userregister.identity.unique'),
